package com.flc.controller.area;

import com.flc.controller.base.BaseController;
import com.flc.entity.Page;
import com.flc.service.area.AreaManager;
...
public class AreaController extends BaseController {
	...
	public ModelAndView exportExcel() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"导出Area到excel");
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var3", varOList.get(i).get("PARENTID").toString());	//3
			vpd.put("var4", varOList.get(i).getString("SHORTNAME"));	    //4
			vpd.put("var5", varOList.get(i).get("LNG").toString());	//5
			vpd.put("var6", varOList.get(i).get("LAT").toString());	//6
			vpd.put("var7", varOList.get(i).get("LEVEL").toString());	//7
			vpd.put("var8", varOList.get(i).get("SORT").toString());	//8
			vpd.put("var9", varOList.get(i).getString("WAIT1"));	    //9
			vpd.put("var10", varOList.get(i).getString("WAIT2"));	    //10
			vpd.put("var11", varOList.get(i).getString("WAIT3"));	    //11
			vpd.put("var12", varOList.get(i).getString("WAIT4"));	    //12
			varList.add(vpd);
		}
