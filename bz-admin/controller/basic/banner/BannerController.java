package com.flc.controller.basic.banner;

import com.flc.controller.base.BaseController;
import com.flc.entity.Page;
import com.flc.service.basic.banner.BannerManager;
...
public class BannerController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		if(null != condition && !"".equals(condition)){
			...
			if(keywords.contains("首")){
				pd.put("keywords", "0");
			}else if(keywords.contains("引导")){
				pd.put("keywords", "2");
			}else if(keywords.contains("欢迎")){
				pd.put("keywords", "1");
			}
		...
		mv.setViewName("basic/banner/banner_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("basic/banner/banner_edit");
