...
public class Test {
		...
		public static final String USER = "yy.baozou@gmail.com";//*必填*：账号名
		public static final String UKEY = "kga982Wbq2JIMBEf";//*必填*: 注册账号后生成的UKEY
//		public static final String SN = "916505603";//*必填*：打印机编号，必须要在管理后台里添加打印机或调用API接口添加之后，才能调用API
		...
		public static void main(String[] args) throws Exception{
			...
			String snlist = "916505605#qkqpm3s7#wu#wu";
//			String snlist = "916505605#qkqpm3s7#wu#wu\n916505603#heafh7kf#remark2#carnum2";
